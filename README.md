...
[![CircleCI](https://circleci.com/gh/infrablocks/terraform-aws-cross-account-role.svg?style=svg)](https://circleci.com/gh/infrablocks/terraform-aws-cross-account-role)

A Terraform module for managing roles assumable across accounts.

The cross account role deployment has no requirements.
 
The cross account role deployment consists of:
* 
...
See the 
[Terraform registry entry](https://registry.terraform.io/modules/infrablocks/cross-account-role/aws/latest) 
for more details.
...
https://github.com/infrablocks/terraform-aws-cross-account-role. 
